...
public class NotesDbAdapter {
    ...
    public static final String KEY_TYPE = "notetype";
     ...
     */
    public long createNote(String body, String type, Date alarm) {
    ...
    public Cursor fetchNote(long rowId) throws SQLException {
        Cursor mCursor =
            mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                    KEY_BODY, KEY_TYPE, KEY_ALARM}, KEY_ROWID + "=" + rowId, null,
                    null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateNote(long rowId, String body, String type, Date alarm) {
